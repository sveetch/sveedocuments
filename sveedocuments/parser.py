...
from sveedocuments.settings_local import DOCUMENTS_PARSER_FILTER_SETTINGS, DOCUMENTS_PARSER_WRITER
from sveedocuments.utils import html5writer
...
def SourceParser(source, setting_key="default", body_only=True, initial_header_level=None, silent=True):
    ...
    if DOCUMENTS_PARSER_WRITER == 'html5':
